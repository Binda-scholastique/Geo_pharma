...
<head>
    ...
    <style>
        ...
        .navbar a:hover { color: #10b981 !important; }

        /* Liens navbar */
        .nav-link-soft { color: #6b7280; }
        .nav-link-soft.active, .nav-link-soft:focus { color: #10b981; }
...
<body class="bg-gray-50 d-flex flex-column min-vh-100">
    <!-- Navigation -->
    <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm sticky-top px-3 px-md-4">
            ...
            <div class="d-flex justify-content-between align-items-center w-100">
                ...
                <div class="d-flex align-items-center">
                    <a href="{{ route('home') }}" class="d-flex align-items-center text-decoration-none">
                        ...
                        <span class="fs-5 fw-bold brand-text">GeoPharma</span>
                    </a>
                </div>
                ...
                <div class="d-none d-md-flex align-items-center">
                    ...
                    <a href="{{ route('pharmacies.search') }}" class="text-decoration-none me-4 px-2 py-1 nav-link-soft">
                ...
                <div class="d-flex align-items-center">
                    @guest
                        <a href="{{ route('login') }}" class="text-decoration-none me-3 nav-link-soft">
                            <i class="fas fa-sign-in-alt me-2"></i>Connexion
                        </a>
                        <a href="{{ route('register') }}" class="btn btn-success shadow-sm">
